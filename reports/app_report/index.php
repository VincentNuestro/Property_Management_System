        ...
        <div class="row form-group" style="margin-bottom: 0px !important;">
            <div class="parent">
                <table class="table table-bordered table-striped fixTable">
                    <thead>
                        <tr>
                            <th width='10%'>Application ID<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="Application_ID"></span></th>
                            <th width='15%'>Application Date<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="applicationDate"></span></th>
                            <th width='20%'>Company Name<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="Company_Name"></span></th>
                            <th width='15%' class="thSysTenant">Trade Name<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="Trade_Name"></span></th>
                            <th width='10%'>Status<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="Status"></span></th>
                            <th width='8%'>Start Date<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="datefrom"></span></th>
                            <th width='8%'>End Date<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="dateto"></span></th>
                            <th width='14%'>Remarks<span class="btnsortdash-application fa fa-sort bigger-130 pull-right" id="xremarks"></span></th>
                        </tr>
                    </thead>
...
<input type="hidden" id="ApplicationSortType" value="ASC">
<input type="hidden" id="ApplicationSortBy" value="applicationDate">
...
<script type="text/javascript">
    ...
    function showappreport(){
        var ApplicationSortBy = $('#ApplicationSortBy').val();
        var ApplicationSortType = $('#ApplicationSortType').val();
        ...
        $.ajax({
            ...
            data: 'dateFrom=' + dateFrom + '&dateTo=' + dateTo + '&page=' + page + '&ApplicationSortBy=' + ApplicationSortBy + '&ApplicationSortType=' + ApplicationSortType + '&form=showappreport',
            beforeSend : function() {
