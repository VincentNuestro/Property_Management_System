		...
		<div class="row form-group" style="margin-bottom: 0px;">
		   ...
		   <div class="col-md-3 div_ListVIew" style="padding-bottom: 5px;padding-left: 0px;">
			...
			<div class="col-md-2" style="padding-bottom: 5px;padding-left: 0px;">
				<div class='btn-group' id="printpenalty" style="display: none;">
			       <button class='btn btn-primary btn-round btn-sm' onclick="$arr = [];$arr.push( 'page='+$('#txtTSRPage').val() );$arr.push( 'key='+$('#txtSearchTenantName').val() );$arr.push( 'DateFrom='+$('#dateFromList').val() );$arr.push( 'DateTo='+$('#dateToList').val() );$arr.push( 'mallid='+$('#txtTSRMall').val() );getheaderprint('<?php echo $_SESSION['MMS-Designation']; ?>','printpenalty',JSON.stringify($arr));" data-placement="bottom">Print</button> 
			        <button data-toggle='dropdown' class='btn dropdown-toggle btn-primary btn-round btn-sm'>
			            <span class='ace-icon fa fa-caret-down icon-only'></span>
			        </button>
			        <ul class='dropdown-menu pull-right'>
			            <li>
			                <a onclick="AutoConsolidatepenalty('<?php echo $_SESSION['MMS-Designation']; ?>');">Export</a>
			            </li>
					</ul>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<!-- <ul class="nav nav-tabs selectedtab" id="mgaList">
									<li id="tabpenalty" onclick="showpenalty(); $('#printpenalty').css('display','block');" class="active"><a data-toggle="tab">Penalty</a></li>
								</ul -->

								<div class="parent reportlists" style="overflow-x: scroll;" id="showpenalty">
									<table class="table table-bordered fixTable">
										<thead>
											...
											<th style="white-space:nowrap;">VATABLE AMOUNT</th>
