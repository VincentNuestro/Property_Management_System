	    ...
	    <div class="row form-group" style="margin-bottom: 0px !important;">
	      	<div class="parent">
		        <table class="table table-bordered table-striped fixTable">
		          	<thead>
			            <tr>
			              	<th width="16%">Date of Accreditation<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id="DateOfAccreditation"></span></th>
			              	<th width="10%">Tenant ID<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id="TenantID"></span></th>
			              	<th width="20%" class="thSysTenant">Trade Name<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id="tradename"></span></th>
			              	<th width="17%">Name of POS Provider<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id="NameofPOSProvider"></span></th>
			              	<th width="17%">Software Version<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id="SoftwareVersion"></span></th>
			              	<th width="10%">Status<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id=""></span></th>
			              	<th width="10%">Options<span class="btnsortdash-accreditation fa fa-sort bigger-130 pull-right" id=""></span></th>
			            </tr>
		          	</thead>
...
<input type="hidden" id="AccreditationSortType" value="ASC">
<input type="hidden" id="AccreditationSortBy" value="TenantID">
