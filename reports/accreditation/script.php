<script type="text/javascript">
	...
	function tblAccreditation(){
		var AccreditationSortBy = $('#AccreditationSortBy').val();
		var AccreditationSortType = $('#AccreditationSortType').val();
		var page = $("#txt_userpageAccreditation").val();
		var key = $("#txtsearchAccreditation").val();
		$.ajax({
			type: 'POsT',
			url: 'reports/accreditation/class.php',
			data: 'page=' + page + '&key=' + key + '&AccreditationSortBy=' + AccreditationSortBy + '&AccreditationSortType=' + AccreditationSortType + '&form=tblAccreditation',
			beforeSend : function() {
