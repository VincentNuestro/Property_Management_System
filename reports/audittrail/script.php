...
<script type="text/javascript">
	...
	function displayaudittrail(){
        var AudittrailSortBy = $('#AudittrailSortBy').val();
        var AudittrailSortType = $('#AudittrailSortType').val();
		...
		$.ajax({
			...
			data: 'page=' + page +'&txtaudittrail=' + txtaudittrail + '&filterbymodule=' + filterbymodule + '&dateFrom=' + dateFrom + '&dateTo=' + dateTo + '&AudittrailSortBy=' + AudittrailSortBy + '&AudittrailSortType=' + AudittrailSortType + '&form=displayaudittrail',
			beforeSend : function() {
