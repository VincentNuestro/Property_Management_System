		...
		<div class="row form-group" style="margin-bottom: 0px !important;">
            <div class="parent">
				<table class="table table-bordered fixTable">
                    <thead>
                        <tr>
							<th style="width: 15%;">User Name<span class="btnsortdash-audittrail fa fa-sort bigger-130 pull-right" id="username"></span></th>
                            <th style="width: 9%;">Time<span class="btnsortdash-audittrail fa fa-sort bigger-130 pull-right" id="mytime"></span></th>
                            <th style="width: 9%;">Date<span class="btnsortdash-audittrail fa fa-sort bigger-130 pull-right" id="mydate"></span></th>
                            <th style="width: 15%;">Module<span class="btnsortdash-audittrail fa fa-sort bigger-130 pull-right" id="module"></span></th>
                            <th style="width: 22%;">Action<span class="btnsortdash-audittrail fa fa-sort bigger-130 pull-right" id="remarks"></span></th>
                            <th style="width: 30%;">Details<span class="btnsortdash-audittrail fa fa-sort bigger-130 pull-right" id="xinfo"></span></th>
                        </tr>
                    </thead>
...
<input type="hidden" id="AudittrailSortType" value="ASC">
<input type="hidden" id="AudittrailSortBy" value="mytime">
<?php
include("script.php");
