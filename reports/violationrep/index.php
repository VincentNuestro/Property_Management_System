	...
	<div class="col-md-12">
		<div class="row form-group" style="margin-bottom: 0px;">
			...
			<!-- ruth -->
				...
				<div class='btn-group' id="printviolation" style="display: none;">
			       <button class='btn btn-primary btn-round btn-sm' onclick="$arr = [];$arr.push( 'page='+$('#txtTSRPage').val() );$arr.push( 'key='+$('#txtSearchTenantName').val() );$arr.push( 'mallid='+$('#txtTSRMall').val() );getheaderprint('<?php echo $_SESSION['MMS-Designation']; ?>','printviolation',JSON.stringify($arr));" data-placement="bottom">Print</button> 
			        <button data-toggle='dropdown' class='btn dropdown-toggle btn-primary btn-round btn-sm'>
			            <span class='ace-icon fa fa-caret-down icon-only'></span>
			        </button>
			        <ul class='dropdown-menu pull-right'>
			            <li>
			                <a onclick="AutoConsolidateviolation('<?php echo $_SESSION['MMS-Designation']; ?>');">Export</a>
			            </li>
					</ul>
				</div>
			</div>
					...
					<div class="col-md-12">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="parent reportlists" style="overflow-x: scroll;" id="showviolation">
									<table class="table table-bordered fixTable">
										<thead>
											...
											<th style="white-space:nowrap;">VSN</th>
											<th style="white-space:nowrap;">VIOLATOR</th>
											<th style="white-space:nowrap;">VIOLATION</th>
											<th style="white-space:nowrap;">VIOLATION LEVEL</th>
