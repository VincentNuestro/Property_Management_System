<?php
	...
	switch ($_POST['form']) {
		...
		case 'dbviolation':
			...
			$violation = mysql_fetch_array(mysql_query("SELECT VSeriesNumber, CODE, Violation, ViolatorID, ViolatorName, offensetype, xstatus, xdate, xdatetime, xfine FROM tblmaintenance_hrviolators WHERE ViolatorID = '". $_POST['key']."';", $connection));
			$rules = mysql_fetch_array(mysql_query("SELECT CODE, violation, 1st_offense, 2nd_offense, 3rd_offense, xsucceeding FROM tblmaintenance_houserules WHERE code = '". $violation[1] ."';", $connection));
				...
				echo 	"<tr>
							...
							<td>". $violation[5]."</td>
							<td>". $violation[9]."</td>
							<td>". date('Y-m-d', strtotime($violation['xdate'])) ."</td>
							<td>". $violation[6]."</td>
						</tr>";	
		break;
		...
		case 'printviolation':
			...
			$rules = mysql_fetch_array(mysql_query("SELECT CODE, violation, 1st_offense, 2nd_offense, 3rd_offense, xsucceeding FROM tblmaintenance_houserules WHERE code = '". $violation[1] ."';", $connection));
					...
					<center> <h2> <b>Violation Report</b> </h2> </center>
					...
					<table  style='width: 100%;' cellspacing='0' cellpadding='0'>
						<thead>
							...
							<th style="border: 1px solid black; text-align: center; color: white; padding:5px !important;"> VSN </th>
							<th style="border: 1px solid black; text-align: center; color: white; padding:3px !important;"> Violator </th>
							<th style="border: 1px solid black; text-align: center; color: white; padding:3px !important;"> Violation </th>
							<th style="border: 1px solid black; text-align: center; color: white; padding:3px !important;"> Violation Level </th>
							<th style="border: 1px solid black; text-align: center; color: white; padding:3px !important;"> Fine </th>
							<th style="border: 1px solid black; text-align: center; color: white; padding:5px !important;"> Date </th>
							<th style="border: 1px solid black; text-align: center; color: white; padding:5px !important;"> Status </th>
						</thead>
						<tbody>		
					<?php
					// while($row = mysql_fetch_array($res)){
						...
						<tr id='<?php echo $row[0]; ?>'>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[4]; ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[0]; ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[4]; ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[2]; ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[5]; ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[9]; ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo date('Y-m-d', strtotime($violation[7])); ?></td>
							<td style="border: 1px solid black; padding:5px;"><?php echo $violation[6]; ?></td>
						</tr>
						<?php
					// }
					?></tbody></table><?php
		...
		case 'AutoConsolidateviolation':
			$violation = mysql_fetch_array(mysql_query("SELECT VSeriesNumber, CODE, Violation, ViolatorID, ViolatorName, offensetype, xstatus, xdate, xdatetime, xfine FROM tblmaintenance_hrviolators WHERE ViolatorID = '". $_POST['tenant']."';", $connection));
			$rules = mysql_fetch_array(mysql_query("SELECT CODE, violation, 1st_offense, 2nd_offense, 3rd_offense, xsucceeding FROM tblmaintenance_houserules WHERE code = '". $violation[1] ."';", $connection));
			$data = "Store Name,VSN,Violator,Violation,Violation Level,Fine,Date,Status\r\n";
			// while($rowcomplaint = mysql_fetch_array($printcomplaint)) 
				$data .= str_replace(",","",$violation[4]).",".$violation[0].",".$violation[4].",".$violation[2].",".$violation[5].",".$violation[9].",".date('Y-m-d', strtotime($violation[7])).",".$violation[6]."\r\n";
			// }
			...
			$file = $syspath."/ViolationReport".date('mdY his').".csv";
			chmod($file, 0777);
			if (file_put_contents($file, $data)){
				create_logs_per_transaction('exported a Violation Report to excel', 'Violation Report', '', '', 'EXPORT', '');
				echo 1;
			}else{
				echo 0;
			}
