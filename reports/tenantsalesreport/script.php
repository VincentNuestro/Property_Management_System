<script type="text/javascript">
	...
	function clickforall(){
		...
		if(tab == "tabsales"){
			dbSales();
			autoascdescdailysales();
			dbSales_Total();
		}else if(tab == "tabhourlysales"){
			dbHour();
			autoascdeschourlysales();
		}else if(tab == "tabpayment"){
			dbPayment();
			autoascdescpaymentsales();
		}else if(tab == "tabdiscount"){
			dbDiscount();
			autoascdesciscounttsales();
		}else if(tab == "tabvoid"){
			dbVoid();
			autoascdescvoidsales();
		}
	}

	function dbSales(){
		var DailySalesSortBy = $('#DailySalesSortBy').val();
		var DailySalesSortType = $('#DailySalesSortType').val();
		...
		$.ajax ({
			...
			data: 'key=' + key + '&DateFrom=' + DateFrom + '&DateTo=' + DateTo + '&page=' + page + '&MallID=' + MallID + '&DailySalesSortBy=' + DailySalesSortBy + '&DailySalesSortType=' + DailySalesSortType + '&form=dbSales',
			success: function(data){
				if(data != ""){
		          	$("#db_sales").html(data);
		        }else{
	...
	function AutoConsolidatedailysales(){
		...
		$.ajax ({
			type: 'POST',
			url: 'reports/tenantsalesreport/class.php',
			data: 'tenant=' + tenant + '&datefrom=' + datefrom + '&dateto=' + dateto + '&mallid=' + mallid + '&DailySalesSortBy=' + DailySalesSortBy + '&DailySalesSortType=' + DailySalesSortType + '&form=AutoConsolidatedailysales',
			success: function (data) {
				if(data == 1){
					setTimeout(function(){
	...
	function autoascdescdailysales(){
		$('.btnsortdash-dailysales').click(function(){
			if($(this).hasClass("fa-sort-up")){
				$(this).addClass("fa-sort-down").removeClass("fa-sort-up");
				$("#DailySalesSortType").val("ASC");
				$("#DailySalesSortBy").val(this.id);
				dbSales();
			}
			else if($(this).hasClass("fa-sort-down")){
				$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
				$("#DailySalesSortType").val("DESC");
				$("#DailySalesSortBy").val(this.id);
				dbSales();
			}else if($(this).hasClass("fa-sort")){
				if($("#DailySalesSortType").val() == "ASC"){
					$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
					$("#DailySalesSortType").val("DESC");
					$("#DailySalesSortBy").val(this.id);
					dbSales();
	...
	function dbHour(){
		var HourlySalesSortBy = $('#HourlySalesSortBy').val();
		var HourlySalesSortType = $('#HourlySalesSortType').val();
	    var page = $("#txtTSRPage").val();
		var MallID = $("#txtTSRMall").val();
		var key = $("#txtSearchTenantName").val();
		var DateFrom = $("#dateFromList").val();
		...
		$.ajax ({
			type: 'POST',
			url: 'reports/tenantsalesreport/class.php',
			data: 'key=' + key + '&DateFrom=' + DateFrom + '&DateTo=' + DateTo + '&page=' + page + '&MallID=' + MallID +  '&HourlySalesSortBy=' + HourlySalesSortBy + '&HourlySalesSortType=' + HourlySalesSortType +  '&form=dbHour',
			success: function(data){
				if(data != ""){
		          	$("#db_hour").html(data);
		        }else{
	...
	function autoascdeschourlysales(){
		$('.btnsortdash-hourlysales').click(function(){
			if($(this).hasClass("fa-sort-up")){
				$(this).addClass("fa-sort-down").removeClass("fa-sort-up");
				$("#HourlySalesSortType").val("ASC");
				$("#HourlySalesSortBy").val(this.id);
				dbHour();
			}
			else if($(this).hasClass("fa-sort-down")){
				$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
				$("#HourlySalesSortType").val("DESC");
				$("#HourlySalesSortBy").val(this.id);
				dbHour();
			}else if($(this).hasClass("fa-sort")){
				if($("#HourlySalesSortType").val() == "ASC"){
					$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
					$("#HourlySalesSortType").val("DESC");
					$("#HourlySalesSortBy").val(this.id);
					dbHour();
	...
	function dbPayment(){
		var PaymentSalesSortBy = $('#PaymentSalesSortBy').val();
		var PaymentSalesSortType = $('#PaymentSalesSortType').val();
	    var page = $("#txtTSRPage").val();
		var MallID = $("#txtTSRMall").val();
		var key = $("#txtSearchTenantName").val();
		var DateFrom = $("#dateFromList").val();
		...
		$.ajax ({
			type: 'POST',
			url: 'reports/tenantsalesreport/class.php',
			data: 'key=' + key + '&DateFrom=' + DateFrom + '&DateTo=' + DateTo + '&page=' + page + '&MallID=' + MallID + '&PaymentSalesSortBy=' + PaymentSalesSortBy + '&PaymentSalesSortType=' + PaymentSalesSortType + '&form=dbPayment',
			success: function(data){
				// alert(data);
				if(data != ""){
	...
	function AutoConsolidatepayment(){
		...
		$.ajax ({
			type: 'POST',
			url: 'reports/tenantsalesreport/class.php',
			data: 'tenant=' + tenant + '&datefrom=' + datefrom + '&dateto=' + dateto + '&mallid=' + mallid + '&PaymentSalesSortBy=' + PaymentSalesSortBy + '&PaymentSalesSortType=' + PaymentSalesSortType + '&form=AutoConsolidatepayment',
			success: function (data) {
				if(data == 1){
					setTimeout(function(){
	...
	function autoascdescpaymentsales(){
		$('.btnsortdash-paymentssales').click(function(){
			if($(this).hasClass("fa-sort-up")){
				$(this).addClass("fa-sort-down").removeClass("fa-sort-up");
				$("#PaymentSalesSortType").val("ASC");
				$("#PaymentSalesSortBy").val(this.id);
				dbPayment();
			}
			else if($(this).hasClass("fa-sort-down")){
				$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
				$("#PaymentSalesSortType").val("DESC");
				$("#PaymentSalesSortBy").val(this.id);
				dbPayment();
			}else if($(this).hasClass("fa-sort")){
				if($("#PaymentSalesSortType").val() == "ASC"){
					$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
					$("#PaymentSalesSortType").val("DESC");
					$("#PaymentSalesSortBy").val(this.id);
					dbPayment();
	...
	function dbDiscount(){
		var DiscountSalesSortBy = $('#DiscountSalesSortBy').val();
		var DiscountSalesSortType = $('#DiscountSalesSortType').val();
	    var page = $("#txtTSRPage").val();
		var MallID = $("#txtTSRMall").val();
		var key = $("#txtSearchTenantName").val();
		var DateFrom = $("#dateFromList").val();
		...
		$.ajax ({
			type: 'POST',
			url: 'reports/tenantsalesreport/class.php',
			data: 'key=' + key + '&DateFrom=' + DateFrom + '&DateTo=' + DateTo + '&page=' + page + '&MallID=' + MallID + '&DiscountSalesSortBy=' + DiscountSalesSortBy + '&DiscountSalesSortType=' + DiscountSalesSortType + '&form=dbDiscount',
			success: function(data){
				if(data != ""){
	...
	function autoascdesciscounttsales(){
		$('.btnsortdash-discountsales').click(function(){
			if($(this).hasClass("fa-sort-up")){
				$(this).addClass("fa-sort-down").removeClass("fa-sort-up");
				$("#DiscountSalesSortType").val("ASC");
				$("#DiscountSalesSortBy").val(this.id);
				dbDiscount();
			}
			else if($(this).hasClass("fa-sort-down")){
				$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
				$("#DiscountSalesSortType").val("DESC");
				$("#DiscountSalesSortBy").val(this.id);
				dbDiscount();
			}else if($(this).hasClass("fa-sort")){
				if($("#DiscountSalesSortType").val() == "ASC"){
					$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
					$("#DiscountSalesSortType").val("DESC");
					$("#DiscountSalesSortBy").val(this.id);
					dbDiscount();
	...
	function dbVoid(){
		var VoidSalesSortBy = $('#VoidSalesSortBy').val();
		var VoidSalesSortType = $('#VoidSalesSortType').val();
	    var page = $("#txtTSRPage").val();
		var MallID = $("#txtTSRMall").val();
		var key = $("#txtSearchTenantName").val();
		var DateFrom = $("#dateFromList").val();
		...
		$.ajax ({
			type: 'POST',
			url: 'reports/tenantsalesreport/class.php',
			data: 'key=' + key + '&DateFrom=' + DateFrom + '&DateTo=' + DateTo + '&page=' + page + '&MallID=' + MallID + '&VoidSalesSortBy=' + VoidSalesSortBy + '&VoidSalesSortType=' + VoidSalesSortType +  '&form=dbVoid',
			success: function(data){
				// alert(data);
				if(data != ""){
		          	$("#db_void").html(data);
	...
	function autoascdescvoidsales(){
		$('.btnsortdash-voidsales').click(function(){
			if($(this).hasClass("fa-sort-up")){
				$(this).addClass("fa-sort-down").removeClass("fa-sort-up");
				$("#VoidSalesSortType").val("ASC");
				$("#VoidSalesSortBy").val(this.id);
				dbVoid();
			}
			else if($(this).hasClass("fa-sort-down")){
				$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
				$("#VoidSalesSortType").val("DESC");
				$("#VoidSalesSortBy").val(this.id);
				dbVoid();
			}else if($(this).hasClass("fa-sort")){
				if($("#VoidSalesSortType").val() == "ASC"){
					$(this).addClass("fa-sort-up").removeClass("fa-sort-down");
					$("#VoidSalesSortType").val("DESC");
					$("#VoidSalesSortBy").val(this.id);
					dbVoid();
