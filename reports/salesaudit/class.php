<?php
	session_start();
	include "../../connect.php";
	$filepath = mysql_fetch_array(mysql_query("SELECT    FROM tblsys_setup;", $connection)); //Get System Setup
	...
	switch ($_POST['form']) {
		case 'sayear':
			...
			echo "SELECT DISTINCT(YEAR(". $tblSales[1] .")) FROM ". $tblSales[0] ." WHERE ". getMallAccess("mallid", "") .";";
