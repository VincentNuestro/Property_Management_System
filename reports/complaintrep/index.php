	...
	<div class="col-md-12">
		<div class="row form-group" style="margin-bottom: 0px;">
			...
			<!-- ruth -->
				...
				<div class='btn-group' id="printcomplaint" style="display: none;">
			       <button class='btn btn-primary btn-round btn-sm' onclick="$arr = [];$arr.push( 'page='+$('#txtTSRPage').val() );$arr.push( 'key='+$('#txtSearchTenantName').val() );$arr.push( 'mallid='+$('#txtTSRMall').val() );getheaderprint('<?php echo $_SESSION['MMS-Designation']; ?>','printcomplaint',JSON.stringify($arr));" data-placement="bottom">Print</button> 
			        <button data-toggle='dropdown' class='btn dropdown-toggle btn-primary btn-round btn-sm'>
			            <span class='ace-icon fa fa-caret-down icon-only'></span>
			        </button>
			        <ul class='dropdown-menu pull-right'>
			            <li>
			                <a onclick="AutoConsolidatecomplaint('<?php echo $_SESSION['MMS-Designation']; ?>');">Export</a>
			            </li>
					</ul>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-md-12">
								<!-- <ul class="nav nav-tabs selectedtab" id="mgaList">
									<li id="tabcomplaint" onclick="showcomplaint(); $('#printcomplaint').css('display','block');" class="active"><a data-toggle="tab">Complaints</a></li>
								</ul> -->

								<div class="parent reportlists" style="overflow-x: scroll;" id="showcomplaint">
									<table class="table table-bordered fixTable">
										<thead>
											...
											<th style="white-space:nowrap;">MALL NAME</th>
											<th style="white-space:nowrap;">WING NAME</th>
											<th style="white-space:nowrap;">UNIT NAME</th>
											<th style="white-space:nowrap;">COMPLAINT DATE</th>
											<th style="white-space:nowrap;">COMPLAINT CODE</th>
											<th style="white-space:nowrap;">COMPLAINT STATUS</th>
											<th style="white-space:nowrap;">PRIORITY STATUS</th>
											</tr>
										</thead>
										<thead>
											<tr>
