            ...
            <div id="forhistory" class="parent">
                <table id="storeinfotable" class="table table-striped table-bordered table-hover fixTable">
                    <thead>
                        <tr>
                            <th width='7%'></th>
                            <th width='14%' class="thSysTenant">Trade Name</th>
                            <th width='8%'>Unit ID</th>
                            <th width='10%'>Unit Name</th>
                            <th width='10%'>Floor Location</th>
                            <th width='15%'>Contract Date</th>
                            <th width='14%'>No. of Months & Days</th>
                            <th width='10%'>Cost per Month</th>
