<?php
	...
	switch ($_POST['form']) {
		...
		case 'dbHour':
			...
			$sql = "SELECT b.tradename, a.". $tblHourly[1] .", a.". $tblHourly[3] .", a.". $tblHourly[4] .", a.". $tblHourly[5] .", a.". $tblHourly[6] .", a.". $tblHourly[7] ." FROM ". $tblHourly[0] ." AS a LEFT JOIN tbltrans_tenants AS b ON a.tenantid = b.TenantID WHERE b.tradename LIKE '%". $_POST['key'] ."%' AND (a.". $tblHourly[1] ." BETWEEN '". date('Y-m-d', strtotime($_POST['DateFrom'])) ."' AND '". date('Y-m-d', strtotime($_POST['DateTo'])) ."') ". $WithMall ." ORDER BY ". $tblHourly[1] .", ". $tblHourly[3] ." LIMIT ". $limit .", 20;";
			$res = mysql_query($sql, $connection);
			while($row = mysql_fetch_array($res)){
				echo 	"<tr>
							<td style='white-space: nowrap;'>". $row[0] ."</td>
		...
		case 'dbPayment':
			...
			$sql = "SELECT b.tradename, a.". $tblPayment[1] .", a.". $tblPayment[3] .", a.". $tblPayment[4] .", a.". $tblPayment[5] .", a.". $tblPayment[6] .", a.". $tblPayment[7] ." FROM ". $tblPayment[0] ." AS a LEFT JOIN tbltrans_tenants AS b ON a.tenantid = b.TenantID WHERE b.tradename LIKE '%". $_POST['key'] ."%' AND (a.". $tblPayment[1] ." BETWEEN '". date('Y-m-d', strtotime($_POST['DateFrom'])) ."' AND '". date('Y-m-d', strtotime($_POST['DateTo'])) ."') ". $WithMall ." ORDER BY ". $tblPayment[1] ." LIMIT ". $limit .", 20;";
			$res = mysql_query($sql, $connection);
			while($row = mysql_fetch_array($res)){
				echo 	"<tr>
							<td style='white-space: nowrap;'>". $row[0] ."</td>
		...
		case 'dbDiscount':
			...
			$res = mysql_query("SELECT b.tradename, a.". $tblDiscount[1] .", a.". $tblDiscount[3] .", a.". $tblDiscount[4] .", a.". $tblDiscount[5] .", a.". $tblDiscount[6] .", a.". $tblDiscount[7] .", a.". $tblDiscount[8] ." FROM ". $tblDiscount[0] ." AS a LEFT JOIN tbltrans_tenants AS b ON a.tenantid = b.TenantID WHERE b.tradename LIKE '%". $_POST['key'] ."%' AND (a.". $tblDiscount[1] ." BETWEEN '". date('Y-m-d', strtotime($_POST['DateFrom'])) ."' AND '". date('Y-m-d', strtotime($_POST['DateTo'])) ."') ". $WithMall ." ORDER BY ".$tblDiscount[1]." LIMIT ". $limit .", 20;", $connection);
			while($row = mysql_fetch_array($res)){
				echo 	"<tr>
							<td style='white-space: nowrap;'>". $row[0] ."</td>
							<td style='white-space: nowrap;'>". date('m/d/Y', strtotime($row[1])) ."</td>
		...
		case 'dbVoid':
			...
			$res = mysql_query("SELECT b.tradename, ".$tblVoid[1].", ".$tblVoid[3].", ".$tblVoid[4].", ".$tblVoid[5].", ".$tblVoid[6].", ".$tblVoid[7].", ".$tblVoid[8]." FROM ".$tblVoid[0]." AS a LEFT JOIN tbltrans_tenants AS b ON a.tenantid = b.TenantID WHERE b.tradename LIKE '%". $_POST['key'] ."%' AND (a.".$tblVoid[1]." BETWEEN '". date('Y-m-d', strtotime($_POST['DateFrom'])) ."' AND '". date('Y-m-d', strtotime($_POST['DateTo'])) ."') ".$WithMall." ORDER BY ".$tblVoid[1]." LIMIT ". $limit .", 20;", $connection);
			while($row = mysql_fetch_array($res)){
				echo 	"<tr>
							<td style='white-space: nowrap;'>". $row[0] ."</td>
							<td style='white-space: nowrap;'>". date('m/d/Y', strtotime($row[1])) ."</td>
		...
		case 'printtenantdailysales':
			$res = mysql_query("SELECT b.tradename, a.fdtTrnsctn, a.fnmGrndTtlOld, a.fnmGrndTtlNew, a.fnmGTDlySls, a.fnmGTDscnt, a.fnmGTDscntSNR, a.fnmGTDscntPWD, a.fnmGTDscntGPC, a.fnmGTDscntVIP, a.fnmGTDscntEMP, a.fnmGTDscntREG, a.fnmGTDscntOTH, a.fnmGTRfnd, a.fnmGTCncld, a.fnmGTSlsVAT, a.fnmGTVATSlsInclsv, a.fnmGTVATSlsExclsv, a.fnmGTCntDcmnt, a.fnmGTCntCstmr, a.fnmGTCntSnrCtzn, a.fnmGTLclTax, a.fnmGTSrvcChrg, a.fnmGTSlsNonVat, a.fnmGTRwGrss, a.fnmGTLclTaxDly, a.fnmGTPymntCSH, a.fnmGTPymntCRD, a.fnmGTPymntOTH FROM fdb_sales AS a LEFT JOIN tbltrans_tenants AS b ON a.tenantid = b.TenantID WHERE b.tradename LIKE '%". $_POST['tenant']."%' AND a.fdtTrnsctn BETWEEN '".date("Y-m-d", strtotime($_POST['datefrom']))."' AND '".date("Y-m-d", strtotime($_POST['dateto']))."' AND a.mallid = '".$_POST['mallid']."' ORDER BY fdtTrnsctn ASC;", $connection);
		...
		case 'AutoConsolidatedailysales':
			$dailysales = "SELECT b.tradename, a.fdtTrnsctn, a.fnmGrndTtlOld, a.fnmGrndTtlNew, a.fnmGTDlySls, a.fnmGTDscnt, a.fnmGTDscntSNR, a.fnmGTDscntPWD, a.fnmGTDscntGPC, a.fnmGTDscntVIP, a.fnmGTDscntEMP, a.fnmGTDscntREG, a.fnmGTDscntOTH, a.fnmGTRfnd, a.fnmGTCncld, a.fnmGTSlsVAT, a.fnmGTVATSlsInclsv, a.fnmGTVATSlsExclsv, a.fnmGTCntDcmnt, a.fnmGTCntCstmr, a.fnmGTCntSnrCtzn, a.fnmGTLclTax, a.fnmGTSrvcChrg, a.fnmGTSlsNonVat, a.fnmGTRwGrss, a.fnmGTLclTaxDly, a.fnmGTPymntCSH, a.fnmGTPymntCRD, a.fnmGTPymntOTH FROM fdb_sales AS a LEFT JOIN tbltrans_tenants AS b ON a.tenantid = b.TenantID WHERE b.tradename LIKE '%". $_POST['tenant']."%' AND a.fdtTrnsctn BETWEEN '".date("Y-m-d", strtotime($_POST['datefrom']))."' AND '".date("Y-m-d", strtotime($_POST['dateto']))."' AND a.mallid = '".$_POST['mallid']."' ORDER BY fdtTrnsctn ASC;";
