		...
		<div class="row form-group" style="margin-bottom: 0px;">
			...
			<div class="col-md-2 div_ListVIew" style="padding-bottom: 5px;padding-left: 0px;">
				<div class='btn-group' id="pdailysales">
			       <button class='btn btn-primary btn-round btn-sm' onclick="$arr = [];$arr.push( 'page='+$('#txtTSRPage').val() );$arr.push( 'tenant='+$('#txtSearchTenantName').val() );$arr.push( 'datefrom='+$('#dateFromList').val() );$arr.push( 'dateto='+$('#dateToList').val() );$arr.push( 'mallid='+$('#txtTSRMall').val() );getheaderprint('<?php echo $_SESSION['MMS-Designation']; ?>','printtenantdailysales',JSON.stringify($arr));" data-placement="bottom">Print Daily Sales</button> 
				...
				<div class='btn-group' id="ppayment">
			       <button class='btn btn-primary btn-round btn-sm' onclick="$arr = [];$arr.push( 'page='+$('#txtTSRPage').val() );$arr.push( 'tenant='+$('#txtSearchTenantName').val() );$arr.push( 'datefrom='+$('#dateFromList').val() );$arr.push( 'dateto='+$('#dateToList').val() );$arr.push( 'mallid='+$('#txtTSRMall').val() );getheaderprint('<?php echo $_SESSION['MMS-Designation']; ?>','printdailypayment',JSON.stringify($arr));" data-placement="bottom">Print Daily Sales</button> 
			        <button data-toggle='dropdown' class='btn dropdown-toggle btn-primary btn-round btn-sm'>
			            <span class='ace-icon fa fa-caret-down icon-only'></span>
			        </button>
			        <ul class='dropdown-menu pull-right'>
									...
									<table class="table table-bordered fixTable">
										<thead>
											<tr>
												...
												<th style="white-space:nowrap;">OLD GRAND TOTAL </th>
												<th style="white-space:nowrap;">NEW GRAND TOTAL</th>
												<th style="white-space:nowrap;">DAILY SALES</th>
												<th style="white-space:nowrap;">GRAND TOTAL DISCOUNT</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - SC</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - PWD</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - GPC</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - VIP</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - EMP</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - REG</th>
												<th style="white-space:nowrap;">TOTAL DISCOUNT - OTH</th>
												<th style="white-space:nowrap;">TOTAL REFUND</th>
												<th style="white-space:nowrap;">TOTAL CANCELED</th>
												<th style="white-space:nowrap;">TOTAL SALES VAT </th>
												<th style="white-space:nowrap;">TOTAL SALES VAT INCLUSIVE</th>
												<th style="white-space:nowrap;">TOTAL SALES VAT EXCLUSIVE</th>
												<th style="white-space:nowrap;">DOCUMENT COUNT</th>
												<th style="white-space:nowrap;">CUSTOMER COUNT</th>
												<th style="white-space:nowrap;">SENIOR CITIZEN COUNT</th>
												<th style="white-space:nowrap;">LOCAL TAX</th>
												<th style="white-space:nowrap;">SERVICE CHARGE</th>
												<th style="white-space:nowrap;">TOTAL SALES NON-VAT</th>
												<th style="white-space:nowrap;">RAW GROSS</th>
												<th style="white-space:nowrap;">DAILY LOCAL TAX </th>
												<th style="white-space:nowrap;">TOTAL PAYMENT - CASH</th>
												<th style="white-space:nowrap;">TOTAL PAYMENT - CARD</th>
												<th style="white-space:nowrap;">TOTAL PAYMENT - OTHERS</th>
											</tr>
										</thead>
										<thead>
											<tr>
								...
								<div class="parent reportlists" style="overflow-x: scroll; display: none;" id="showHour">
									<table class="table table-bordered fixTable">
										<thead>
											<th style="white-space:nowrap;text-transform: uppercase;" class="thSysTenant">MERCHANT NAME</th>
											<th style="white-space:nowrap;">TRANSACTION DATE</th>
											<th style="white-space:nowrap;">HOUR CODE</th>
											<th style="white-space:nowrap;">DAILY SALES</th>
											<th style="white-space:nowrap;">DOCUMENT COUNT</th>
											<th style="white-space:nowrap;">CUSTOMER COUNT</th>
											<th style="white-space:nowrap;">SENIOR CITIZEN COUNT</th>
								...
								<div class="parent reportlists" style="overflow-x: scroll; display: none;" id="showPayment">
									<table class="table table-bordered fixTable">
										<thead>
											<th  style="white-space:nowrap;text-transform: uppercase;" class="thSysTenant">MERCHANT NAME</th>
											<th  style="white-space:nowrap;">TRANSACTION DATE</th>
											<th  style="white-space:nowrap;">PAYMENT CODE</th>
											<th  style="white-space:nowrap;">PAYMENT DESCRIPTION</th>
											<th  style="white-space:nowrap;">PAYMENT CODE CLASSIFICATION</th>
											<th  style="white-space:nowrap;">PAYMENT CODE DESCRIPTION</th>
								...
								<div class="parent reportlists" style="overflow-x: scroll; display: none;" id="showDiscount">
									<table class="table table-bordered fixTable">
										<thead> 
											...
											<th style="white-space:nowrap;">DISCOUNT PERCENTAGE</th>
