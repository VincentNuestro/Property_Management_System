  ...
  <div class="row form-group" style="margin-bottom: 0px;padding-top:10px;background-color: #edf4f8;padding-bottom: 10px;">
    ...
    <div class="col-md-8 col-xs-12">
      <div class="row form-group">
        <span class='pull-right label label-danger arrowed-in-right arrowed' style="margin-right: 10px;color: black;">Disapproved</span>
        ...
        <span class='pull-right label label-light arrowed-in-right arrowed' style="margin-right: 5px;color: black;">Inquired</span>
...
<div class="row">
	<div class="col-xs-12">
		<div class="row form-group" style="margin-bottom: 0px;">
          ...
          <input type="text" class="form-control" id="txtsearchLMinquiry" title="Search" placeholder="Search" onkeyup="showtblleasinginquirylist();">
          <i class="ace-icon fa fa-search nav-search-icon"></i>
        </span>
      </div>
      <div class="col-md-4" style="padding-bottom: 5px;padding-left:0px;">
          <h5><a onclick="loadLMInquiryFilter('LMInquiry')" id="LINK_Inquiry_filter" class="popover-info" data-rel="popover" data-placement="bottom" title="Filter by" data-content='
            <fieldset style="margin: 8px;border: 1px dotted #CCC;padding: 8px;margin-top: 0px;">
              <legend style="border: none;margin-bottom: 0px;font-size: 15px; font-weight: normal;width:95px;">&nbsp;&nbsp;Select by&nbsp;&nbsp;</legend>
                <div class="form-group row" style="margin:0px;">
                  <div class="col-md-4">
                    <label>
                       <input name="form-field-checkboxlminq" class="ace ace-checkbox-2" type="checkbox" value="b.mallname" id="filter_b.mallname">
                       <span class="lbl"> Company</span>
                    </label>
                  </div>
                  <div class="col-md-4">
                    <label>
                        <input name="form-field-checkboxlminq" class="ace ace-checkbox-2" type="checkbox" value="a.Fullname" id="filter_a.Fullname">
                        <span class="lbl"> Name</span>
                    </label>
                  </div>
                  <div class="col-md-4">
                    <label>
                        <input name="form-field-checkboxlminq" class="ace ace-checkbox-2" type="checkbox" value="c.unitname" id="filter_c.unitname">
                        <span class="lbl"> Unit</span>
                    </label>
                  </div>
                  <div class="col-md-4">
                    <label>
                        <input name="form-field-checkboxlminq" class="ace ace-checkbox-2" type="checkbox" value="a.Mobile_No" id="filter_a.Mobile_No">
                        <span class="lbl"> Mobile Number</span>
                    </label>
                  </div>
                  <div class="col-md-4">
                    <label>
                        <input name="form-field-checkboxlminq" class="ace ace-checkbox-2" type="checkbox" value="a.EmailAddress" id="filter_a.EmailAddress">
              ...
              <legend style="border: none;margin-bottom: 0px;font-size: 15px; font-weight: normal;width:100px;">&nbsp;&nbsp;Filter Status&nbsp;&nbsp;</legend>
                <div class="form-group row" style="margin:0px;">
                  <div class="col-md-4" style="padding-right:0px;">
                    <label class="label label-light" style="margin-bottom: 0px;height:22px;padding-left:4px;color: black;">
                      <input name="form-field-checkboxlminqstat" class="ace" type="checkbox" value="Inquired" id="filter_Inquired">
                  ...
                  <div class="col-md-4" style="padding-right:0px;">
                    <label class="label label-success" style="margin-bottom: 0px;height:22px;padding-left:4px;color: black;">
                      <input name="form-field-checkboxlminqstat" class="ace" type="checkbox" value="Approved" id="filter_Approved">
                  ...
                  <div class="col-md-4" style="padding-right:0px;">
                    <label class="label label-primary" style="margin-bottom: 0px;height:22px;padding-left:4px;color: black;">
                      <input name="form-field-checkboxlminqstat" class="ace" type="checkbox" value="Reserved" id="filter_Reserved">
                  ...
                  <div class="col-md-4" style="padding-right:0px;">
                    <label class="label label-warning" style="margin-bottom: 0px;height:22px;padding-left:4px;color: black;">
                      <input name="form-field-checkboxlminqstat" class="ace" type="checkbox" value="Occupied" id="filter_Occupied">
                  ...
                  <div class="col-md-4">
                    <label class="label label-danger" style="margin-bottom: 0px;height:22px;padding-left:4px;color: black;">
                      <input name="form-field-checkboxlminqstat" class="ace" type="checkbox" value="Disapproved" id="filter_Disapproved">
            ...
            <fieldset style="margin: 8px;border: 1px dotted #CCC;padding: 8px;" id="div_chkappdate">
                ...
                <div class="form-group row" style="margin:0px;">
                  ...
                  <div class="col-md-5">
                    <div class="input-group">
                      ...
                      <input class="form-control div_app date-picker" type="text" name="" id="txtLMinqDateFrom" data-provide="datepicker">
                    </div>
                  </div>
                  <div class="col-md-5">
                    <div class="input-group">
                      ...
                      <input class="form-control div_app date-picker" type="text" name="" id="txtLMinqDateTo" data-provide="datepicker">
                    </div>
                  </div>
                  <div class="col-md-1">
                  </div>
              ...
              <div class="form-group row" style="padding-left:8px;margin-bottom:0px;">
                ...
                <div class="col-md-3">
                  <button class="btn btn-xs btn-info" onclick="saveLMInquiryFilter()" style="float:right;margin-bottom:10px;margin-right:10px;width:80px;">
                      OK
                  </button>
                </div>
        ...
        <div class="col-xs-12 col-md-12 col-lg-12">
    			<div class="parent">
                  ...
                  <th>Unit</th>
        			...
        			<tbody id="tblleasinginquirylist"></tbody>
        		</table>
          </div>
            ...
            <thead>
              <tr>
                <th style="width: 100%;padding-top: 10px;padding-bottom: 10px;">
                  <font id="txtLMinqenties" style="float: left;margin-left: 15px;font-weight: normal;font-weight: 8px !important;"></font>
                  <input id="txt_LMinquserpage" type="hidden">
                  <ul id="ulLMinqpagination" class="pagination pull-right"></ul>
                </th>
              </tr>
            </thead>
          </table>
  ...
  <div class="modal-dialog modal-lg" style="width: 85%;">
    <div class="modal-content">
                      ...
                      <div class="widget-main">
                        <div class="row well">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-2">
                              <input type="text" class="form-control mustclearfirst date-picker" id="txtLMBirthdate" placeholder="mm/dd/YYYY">
                            </div>
                            <div class="col-md-2">
                          ...
                          <div class="col-md-12" style="margin-top: 5px;">
                            ...
                            <div class="col-md-4">
                              <b>Citizenship(Indicate both if dual citizenship)</b>
                            </div>
                        ...
                        <div class="row well">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="row form-group">
                                <div class="col-md-4">
                                  <label style="color: red;" id="txtLMPD"></label> <b>Promo Discount</b>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-6">
                              ...
                              <div class="row form-group">
                                <div class="col-md-4">
                                  <label style="color: red;" id="txtLMCD"></label> <b>Company Discount</b>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-6">
                              ...
                              <div class="row form-group">
                                <div class="col-md-4">
                                  <label style="color: red;" id="txtLMSD"></label> <b>Standard Discount</b>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Spot Cash</span>
                                    </label>
                                  </div>
                                </div>
                                <!-- <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Installment</span>
                                    </label>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                <div class="col-md-3">
                                  <label style="color: red;" id="txtLMSDP"></label> <b>Spot Down Payment</b>
                                </div>
                                <div class="col-md-4">
                              ...
                              <div class="row form-group">
                                <div class="col-md-3">
                                  <label style="color: red;" id="txtLMNDP"></label> <b>Net Down Payment</b>
                                </div>
                                <div class="col-md-4">
                              ...
                              <div class="row form-group">
                                <div class="col-md-3">
                                  <label style="color: red;" id="txtLMB"></label> <b>Balance</b>
                                </div>
                                <div class="col-md-4">
                              ...
                              <div class="row form-group">
                                <div class="col-md-7">
                                  <b>Validity Date of Payment Scheme</b>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Booth / Showroom</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Event</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Advertisement</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Repeat Buyer</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Internet</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;E-mail</span>
                                    </label>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Flyer</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Referral</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Employee</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Broker / Agent</span>
                                    </label>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Primary Home</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;Secondary Home</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;For Rental / Resale</span>
                                    </label>
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <div class="checkbox">
                                    <label>
                                        ...
                                        <span class="lbl" style="color: #666;font-weight: bold;">&nbsp;&nbsp;For Other Family Members</span>
                                    </label>
                                  </div>
                                </div>
                              </div>
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" id="LMINQbtnforsaving" onclick="saveLMinquiry()"><i class="ace-icon fa fa-check"></i>&nbsp;Save</button>
        <button class="btn btn-primary" id="LMINQbtnforapproving" style="display: none;" onclick="confirmapproveLMinquiry()"><i class="ace-icon fa fa-check"></i>&nbsp;Approve</button>
        <button class="btn btn-danger" id="LMINQbtnfordisapproving" style="display: none;" onclick="confirmdisapproveLMinquiry()"><i class="ace-icon fa fa-times"></i>&nbsp;Disapprove</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-lg" style="width: 98%;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="parent">
            <table class="table table-hover table-bordered fixTable" width="100%">
              <thead>
                  <tr>
          ...
          <table class="tabledash_footer table" style="margin: 0px !important;">
            <thead>
              <tr>
                <input type="hidden" id="txt_quickselectuserpage">
                <th id="th_tabledash_footer" width="" colspan="7" style="width: 911px;padding-top: 15px;padding-bottom: 15px;">
                <font style="float: left; color: white !important;margin-left: 15px;font-weight: normal;font-weight: 8px !important;" id="txtquickselectenties"><br /></font>
...
<div class="modal fade fade-scale" id="modal_addnewposition" role="dialog" area-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog modal-sm">   
    <div class="modal-content">
      <div class="modal-body">
        <button type="button" class="close" onclick="hidemodal_addnewposition()">&times;</button>
        <h4 class="modal-title">Company Position</h4>
        <div class="row form-group">
          <div class="col-xs-12 col-md-12">
            <table table id="simple-table" class="table  table-bordered table-hover" style="display: flex;flex-flow: column;height: 100%;width: 100%;margin-top: 10px !important;">
              <tbody id="tblcompposlist" style="flex: 1 1 auto;display: block;height: 20em;overflow-x: hidden;"></tbody>
            </table>
            <hr />
            <h6 class="modal-title">New Position</h6>
            <h6 class="modal-title" style="font-size: 10px;font-style: italic;">(if not on the list)</h6>
            <div class="input-group">
              <input type="text" id="txtLMinqNewCompPos" class="form-control" placeholder="Add New">  
              <div class="spinbox-buttons input-group-btn">         
                 <button type="button" class="btn btn-success" onclick="savenewcomppos();" style="height: 34px;padding-top:2px;">&nbsp;Add          
                  <i class="icon-only  ace-icon ace-icon fa fa-plus bigger-110"></i>          
                </button>       
              </div>
            </div>
