<div class="page-header">
    <div class="row form-group" style="margin-bottom: 0px;padding-top:10px;background-color: #edf4f8;padding-bottom: 10px;">
        <div class="col-md-4">
            <h1 style="font-weight: bold;">PROPOSALS</h1>
        </div>
        <div class="col-md-8">
            ...
            <div class="col-md-2" style="padding-bottom: 5px;padding-left:0px;">
                <h5><a onclick="loadFilterLeasingApplication('Application')" id="LINK_Appliaction_filter" class="popover-info" data-rel="popover" data-placement="bottom" title="Filter by" data-content='
                        ...
                        <div class="form-group row" style="margin: 0px;">
                            ...
                            <div class="col-md-5">
                                <label class="label label-lg label-pink arrowed-in-right arrowed">
                                    <input name="form-field-checkbox-stat" class="ace" type="checkbox" value="0" id="filter_Pendingproposal">
                                    <span class="lbl"> Pending </span>
                                </label>
                            </div>
                            <div class="col-md-5">
                                <label class="label label-lg label-success arrowed-in-right arrowed">
                                    <input name="form-field-checkbox-stat" class="ace" type="checkbox" value="1" id="filter_Approvedproposal">
                    ...
                    <fieldset style="margin: 8px;border: 1px dotted #CCC;padding: 8px;" id="div_chkappdate">
                        <legend style="border: none;margin-bottom: 0px;font-size: 15px; font-weight: normal;width:130px;">&nbsp;&nbsp;Proposal Created</legend>
                        <div class="form-group row" style="margin:0px;">
                            <div class="col-md-1"></div>
                            <div class="col-md-5">
                    ...
                    <div class="form-group row" style="padding-left:8px;margin-bottom:0px;">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-xs btn-info btn-round" onclick="saveapprovalproposalFilter()" style="float:right;margin-bottom:10px;margin-right:10px;width:80px;">OK</button>
                        </div>
