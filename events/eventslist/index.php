                ...
                <h5><a onclick="loadFilterLeasingApplication('Application')" id="LINK_Appliaction_filter" class="popover-info" data-rel="popover" data-placement="bottom" title="Filter by" data-content='
                    ...
                    <fieldset style="margin: 8px;border: 1px dotted #CCC;padding: 8px;margin-top: 0px;">
                        ...
                        <div class="form-group row" style="margin:0px;">
                            <div class="col-md-6">
                                <label>
                                    <input name="form-field-checkboxkeyword" class="ace ace-checkbox-2 inquiry_module_filter" type="checkbox" value="Company" id="filter_Company">
                                    <span class="lbl"> Organizer</span>
                                </label>
                            </div>
                            <div class="col-md-6">
                                <label>
                                    <input name="form-field-checkboxkeyword" class="ace ace-checkbox-2 inquiry_module_filter" type="checkbox" value="RevType" id="filter_RevType">
                                    <span class="lbl"> Revenue Type <span class=""></span></span>
                                </label>                            
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset style="margin: 8px;border: 1px dotted #CCC;padding: 8px;" id="div_chkappdate">
                        <legend style="border: none;margin-bottom: 0px;font-size: 15px; font-weight: normal;width:130px;">&nbsp;&nbsp;Events Created</legend>
                        <div class="form-group row" style="margin:0px;">
                    ...
                    <div class="form-group row" style="padding-left:8px;margin-bottom:0px;">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-xs btn-info btn-round" onclick="saveapprovaleventsFilter()" style="float:right;margin-bottom:10px;margin-right:10px;width:80px;">OK</button>
                        </div>
        ...
        <div class="row form-group" style="margin-bottom: 0px !important;" id="user-profile-3">
            <div class="parent">
                <table class="table table-bordered fixTable">
                    ...
                    <tbody id="tblListofevents"></tbody>
               </table>
            </div>
...
<div class="modal fade" id="mdlProposalselectprint" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header" style="background-color: white !important;">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h6 style="font-size: 14px; font-weight: 400; color: #666; margin: 0px;"><span class="fa fa-info-circle" style="color: #06F;"></span>&nbsp;&nbsp;Select what to Print</h6>
            </div>
            <div class="modal-body" id="btnProposalxPreview"></div>
            <div class="modal-footer">
