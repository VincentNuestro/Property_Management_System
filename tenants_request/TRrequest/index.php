<div class="page-header">
    <div class="row form-group" style="margin-bottom: 0px;padding-top:10px;background-color: #edf4f8;padding-bottom: 10px;">
        <div class="col-md-6">
            <h1 style="font-weight: bold;">TENANT'S REQUEST</h1>
        </div>
        <div class="col-md-6">
...
<div class="row">
    <div class="row form-group" style="margin-bottom: 0px;">
        <div class="col-md-2"  style="padding-bottom: 5px;">
            <span class="input-icon" style="width: 100%;visibility: hidden;">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-round btn-sm tentssave" style="display: none" onclick="SaveRequestTenant();"><i class="fa fa-check"></i>&nbsp;Save</button>
                <button class="btn btn-primary btn-round btn-sm tentsview" style="display: none" onclick="Editrequesttenant();"><i class="fa fa-check"></i>&nbsp;Edit</button>
...
<div class="modal fade fade-scale" id="modaledittime" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="closeedittime();">&times;</button>
                <h4 class="modal-title" style="font-family: Roboto;font-size: 18px;">Edit Timelogs</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-9">
                            <input type="hidden" id="txttreditid" name="">
                            <input type="hidden"  id="txtedittype" name="">
                            <input type="text" class=" form-control timepickeronly" id="txteditlogsx" >
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary btn-round btn-sm "  onclick="saveedittime();"><i class="fa fa-check"></i>&nbsp;Save</button>
            </div>
        </div>
    </div> 
</div>

<div class="modal fade fade-scale" id="modaleditimage" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="closeeditimage();">&times;</button>
                <h4 class="modal-title" style="font-family: Roboto;font-size: 18px;">Edit Image</h4>
            </div>
            <div class='modal-body'>
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-9">
                        <input type="hidden" id="txttreditimageid" name="">
                        <form id="frmuploadvisitedit" method="POST" action="" enctype="multipart/form-data" >
                            <input type="file" id="" name="files" class="id-input-file">
                            <input type="submit" style="display: none;" id="btnuploadvisitimageedit" name="">
                        </form>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary btn-round btn-sm "  onclick="saveeditimage();"><i class="fa fa-check"></i>&nbsp;Save</button>
            </div>
        </div>
    </div> 
</div>
