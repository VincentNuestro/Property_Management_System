<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Lease Application') }} - {{ $leaseApplication->application_number }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card>
                <form method="POST" action="{{ route('lease-applications.update', $leaseApplication) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            >
                                ...
                                @foreach($properties as $property)
                                    <option value="{{ $property->id }}" {{ old('property_id', $leaseApplication->property_id) == $property->id ? 'selected' : '' }}>
                        ...
                        <div class="md:col-span-2">
                            ...
                            >
                                ...
                                @foreach($tenants as $tenant)
                                    <option value="{{ $tenant->id }}" {{ old('tenant_id', $leaseApplication->tenant_id) == $tenant->id ? 'selected' : '' }}>
                                        {{ $tenant->full_name }}
                                        @if($tenant->email)
                                            ({{ $tenant->email }})
                                        @endif
                        ...
                        <x-form.input
                            ...
                            type="date"
                            :value="old('application_date', $leaseApplication->application_date->format('Y-m-d'))"
                            :required="true"
                        />
                        ...
                        <x-form.input
                            ...
                            type="date"
                            :value="old('desired_start_date', $leaseApplication->desired_start_date->format('Y-m-d'))"
                            :required="true"
                        ...
                        <x-form.input
                            ...
                            type="number"
                            :value="old('desired_lease_term', $leaseApplication->desired_lease_term)"
                            :required="true"
                            min="1"
                            max="120"
                    ...
                    <div class="mt-6">
                        <x-form.textarea
                            label="Notes"
                            name="notes"
                            :value="old('notes', $leaseApplication->notes)"
                            rows="4"
                    ...
                    <div class="mt-6 flex items-center justify-end space-x-4">
                        <a href="{{ route('lease-applications.show', $leaseApplication) }}">
