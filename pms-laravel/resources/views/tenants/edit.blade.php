<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card>
                <form method="POST" action="{{ route('tenants.update', $tenant) }}" id="tenantForm">
                    @csrf
                    @method('PUT')
                            ...
                            @foreach($tenantTypes as $type)
                                <label class="flex items-center">
                                    <input
                                        ...
                                        name="tenant_type"
                                        value="{{ $type['value'] }}"
                                        {{ old('tenant_type', $tenant->tenant_type->value) == $type['value'] ? 'checked' : '' }}
                    ...
                    <div id="individualFields" class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <x-form.input
                                ...
                                name="date_of_birth"
                                type="date"
                                :value="$tenant->date_of_birth?->format('Y-m-d')"
                            />
                            ...
                            <x-form.input
                                ...
                                type="text"
                                :value="$tenant->government_id_type"
                            ...
                            <x-form.input
                                ...
                                type="text"
                                :value="$tenant->government_id_number"
                            />
                        </div>
                    </div>
