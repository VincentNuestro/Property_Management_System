                ...
                <form method="GET" action="{{ route('payments.index') }}" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <select name="payment_method" id="payment_method" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="flex items-end">
                            <label class="flex items-center">
                                <input type="checkbox" name="unapplied_only" value="1" {{ request('unapplied_only') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                <span class="ml-2 text-sm text-gray-600">Unapplied Only</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            @if(request()->hasAny(['search', 'status', 'payment_method', 'property_id', 'tenant_id', 'date_from', 'date_to', 'unapplied_only']))
                                <a href="{{ route('payments.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">
                                    Clear Filters
                                </a>
                            @endif
                        </div>
                            ...
                            @forelse($payments as $payment)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <span class="{{ $payment->unapplied_amount > 0 ? 'text-orange-600' : 'text-green-600' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        ...
                                        @can('allocate', $payment)
                                            @if($payment->unapplied_amount > 0)
                                                <a href="{{ route('payments.allocate', $payment) }}" class="text-green-600 hover:text-green-900">Allocate</a>
                                            @endif
                                        @endcan
                                    </td>
                                </tr>
