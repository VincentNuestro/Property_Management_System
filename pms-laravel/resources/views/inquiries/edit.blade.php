<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Inquiry') }} - {{ $inquiry->inquiry_number }}
        </h2>
    </x-slot>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <x-form.input
                                ...
                                type="number"
                                step="0.01"
                                :value="$inquiry->desired_area_sqm"
                            />
                            ...
                            <x-form.input
                                ...
                                type="date"
                                :value="$inquiry->desired_move_in_date?->format('Y-m-d')"
                            />
                        </div>
                    </div>
