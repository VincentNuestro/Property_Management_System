            ...
            <x-card class="mb-6">
                <form method="GET" action="{{ route('properties.index') }}" class="space-y-4">
                    ...
                    @if(request()->hasAny(['search', 'type', 'status']))
                        <div>
                            <a href="{{ route('properties.index') }}" class="text-sm text-indigo-600 hover:text-indigo-900">
                                Clear Filters
                            </a>
                        </div>
                    @endif
                            ...
                            @forelse($properties as $property)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('properties.show', $property) }}" class="text-sm font-medium text-indigo-600 hover:text-indigo-900">
                                            {{ $property->name }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        ...
                                        @can('properties.edit')
                                            <a href="{{ route('properties.edit', $property) }}" class="text-yellow-600 hover:text-yellow-900">Edit</a>
                                        @endcan
