...
class UpdateLeaseContractRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('lease_contracts.edit');
    }
    ...
    {
        $leaseContractId = $this->route('lease_contract')->id;

        return [
            'property_id' => ['required', 'exists:properties,id'],
            'tenant_id' => ['required', 'exists:tenants,id'],
            'contract_number' => ['nullable', 'string', 'max:50', Rule::unique('lease_contracts', 'contract_number')->ignore($leaseContractId)],
