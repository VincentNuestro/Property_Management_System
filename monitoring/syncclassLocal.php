<?php
	...
	switch ($_POST['form']) {
		case 'importcsvtoday':
			...
			$SuccessCount = 0;
			$ExistingCount = 0;
			$resTenant = mysql_query("SELECT mallID, merchant_code, TenantID, withPOS, unitID FROM tbltrans_tenants WHERE (Status = 'Active' OR Status = 'ForEviction' OR Status = 'ForRenewal') AND ustatus = 'Occupied' AND uploadingoffiles = '1' AND datefrom <= '". date('Y-m-d', strtotime(getsysdate())) ."' AND dateto >= '". date('Y-m-d', strtotime(getsysdate())) ."' ORDER BY tradename ASC;", $connection);
							...
							if(file_exists($FileName . "R.csv")){
								...
								while(($resVoidCSV = fgetcsv($OpenVoidCSV)) != FALSE){
									if($resVoidCSV[0] != "" || $resVoidCSV[1] != "" || $resVoidCSV[2] != "" || $resVoidCSV[3] != "" || $resVoidCSV[4] != "" || $resVoidCSV[5] != "" || $resVoidCSV[6] != "" || $resVoidCSV[7] != ""){
										...
										if(date('Y-m-d', strtotime($resVoidCSV[0])) != date('Y-m-d', strtotime($StartDate)) || $resVoidCSV[1] != $rowTenant['merchant_code']){
											$VoidRowCount++;
										}
		...
		case 'importcsvlate':
			...
			$rowTenant = mysql_fetch_array(mysql_query("SELECT mallID, merchant_code, TenantID, withPOS FROM tbltrans_tenants WHERE TenantID = '". $rowRefNo[1] ."';", $connection));
			$filepath = mysql_fetch_array(mysql_query("SELECT filepath, dbsetup FROM tblsys_setup;", $connection));
			$SystemSetupPath = str_replace("\\", "/", $filepath['filepath']);
			$tblPayment = tblPayment($filepath['dbsetup']);
			...
			if($filepath['dbsetup'] == "1"){
				// FOR MONTH
				if(date('n', strtotime($rowRefNo['reportDate'])) == "1"){
					$Month = "1";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "2"){
					$Month = "2";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "3"){
					$Month = "3";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "4"){
					$Month = "4";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "5"){
					$Month = "5";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "6"){
					$Month = "6";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "7"){
					$Month = "7";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "8"){
					$Month = "8";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "9"){
					$Month = "9";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "10"){
					$Month = "A";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "11"){
					$Month = "B";
				}else if(date('n', strtotime($rowRefNo['reportDate'])) == "12"){
					$Month = "C";
				}

				// FOR DAY
				if(date('j', strtotime($rowRefNo['reportDate'])) == "1"){
					$Day = "1";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "2"){
					$Day = "2";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "3"){
					$Day = "3";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "4"){
					$Day = "4";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "5"){
					$Day = "5";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "6"){
					$Day = "6";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "7"){
					$Day = "7";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "8"){
					$Day = "8";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "9"){
					$Day = "9";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "10"){
					$Day = "A";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "11"){
					$Day = "B";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "12"){
					$Day = "C";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "13"){
					$Day = "D";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "14"){
					$Day = "E";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "15"){
					$Day = "F";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "16"){
					$Day = "G";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "17"){
					$Day = "H";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "18"){
					$Day = "I";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "19"){
					$Day = "J";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "20"){
					$Day = "K";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "21"){
					$Day = "L";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "22"){
					$Day = "M";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "23"){
					$Day = "N";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "24"){
					$Day = "O";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "25"){
					$Day = "P";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "26"){
					$Day = "Q";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "27"){
					$Day = "R";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "28"){
					$Day = "S";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "29"){
					$Day = "T";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "30"){
					$Day = "U";
				}else if(date('j', strtotime($rowRefNo['reportDate'])) == "31"){
					$Day = "V";
				}
			}else{
				// FOR MONTH
			...
			$FileName = $SystemSetupPath . $rowTenant['mallID'] ."/". $rowTenant['merchant_code'] ."/". $rowTenant['merchant_code'] . $Month . $Day . date('y', strtotime($rowRefNo['reportDate']));
			...
			try{
				...
				if($rowRefNo['paymenttype'] != 1){
					if(file_exists($FileName . "P.csv")){
						...
						$OpenPaymentCSV = fopen($FileName . "P.csv", "r");
						$resPaymentCSV = fgetcsv($OpenPaymentCSV, 1000, ";"); //REMOVE CSV HEADERS
						while(($datapaymenttypes = fgetcsv($OpenPaymentCSV)) != FALSE){
							if($rowPaymentCSV[0] != "" || $rowPaymentCSV[1] != "" || $rowPaymentCSV[2] != "" || $rowPaymentCSV[3] != "" || $rowPaymentCSV[4] != "" || $rowPaymentCSV[5] != "" || $rowPaymentCSV[6] != ""){
					...
					if(file_exists($FileName . "R.csv")){
						...
						while(($rowVoidCSV = fgetcsv($OpenVoidCSV)) != FALSE){
							if($rowVoidCSV[0] != "" || $rowVoidCSV[1] != "" || $rowVoidCSV[2] != "" || $rowVoidCSV[3] != "" || $rowVoidCSV[4] != "" || $rowVoidCSV[5] != "" || $rowVoidCSV[6] != "" || $rowVoidCSV[7] != ""){
								...
								if(date('Y-m-d', strtotime($rowVoidCSV[0])) != date('Y-m-d', strtotime($rowRefNo['reportDate'])) || $rowVoidCSV[1] != $rowTenant['merchant_code']){
									$VoidRowCount++;
								}
					...
					if(file_exists($FileName . "S.csv")){
						...
						while(($rowSalesCSV = fgetcsv($OpenSalesCSV)) != FALSE){
							if($rowSalesCSV[0] != "" || $rowSalesCSV[1] != "" || $rowSalesCSV[2] != "" || $rowSalesCSV[3] != "" || $rowSalesCSV[4] != "" || $rowSalesCSV[5] != "" || $rowSalesCSV[6] != "" || $rowSalesCSV[7] != "" || $rowSalesCSV[8] != "" || $rowSalesCSV[9] != "" || $rowSalesCSV[10] != "" || $rowSalesCSV[11] != "" || $rowSalesCSV[12] != "" || $rowSalesCSV[13] != "" || $rowSalesCSV[14] != "" || $rowSalesCSV[15] != "" || $rowSalesCSV[16] != "" || $rowSalesCSV[17] != "" || $rowSalesCSV[18] != "" || $rowSalesCSV[19] != "" || $rowSalesCSV[20] != "" || $rowSalesCSV[21] != "" || $rowSalesCSV[22] != "" || $rowSalesCSV[23] != "" || $rowSalesCSV[24] != "" || $rowSalesCSV[25] != "" || $rowSalesCSV[26] != "" || $rowSalesCSV[27] != "" || $rowSalesCSV[28] != "" || $rowSalesCSV[29] != "" || $rowSalesCSV[30] != "" || $rowSalesCSV[31] != "" || $rowSalesCSV[32] != ""){
								...
								if(date('Y-m-d', strtotime($rowSalesCSV[0])) == date('Y-m-d', strtotime($rowRefNo['reportDate'])) && $rowSalesCSV[1] == $rowTenant['merchant_code']){
				...
				$resSync = mysql_query("UPDATE db_syncfilestat SET sales = '". $SalesVal ."', discount = '". $DiscountVal ."', void_refund = '". $VoidVal ."', salesperhour = '". $HourlyVal ."', paymenttype = '". $PaymentVal ."', countSync = '". $CSVStats ."' WHERE refno = '". $_POST['refno'] ."';", $connection);
				if($resSync == true){
					$newTotal = $rowRefNo['merchant_code'] + $CSVStats;
					if($newTotal == 5){
