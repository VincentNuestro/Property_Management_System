<div class="page-header">
    <div class="row form-group" style="margin-bottom: 0px;padding-top:10px;background-color: #edf4f8;padding-bottom: 10px;">
        ...
        <div class="col-md-8">
            ...
            <span class='pull-right arrowed-in-right arrowed label label-xlg label-danger'>Cancelled</span>
            ...
            <div class="col-md-2" style="padding-bottom: 5px;padding-left:0px;">
                <h5><a onclick="loadFilterLeasingApplication('Application')" id="LINK_Appliaction_filter" class="popover-info" data-rel="popover" data-placement="bottom" title="Filter by" data-content='
                        ...
                        <div class="form-group row" style="margin: 0px;">
                            ...
                            <div class="col-md-4">
                                <label class="label label-lg label-yellow arrowed-in-right arrowed">
                                    <input name="form-field-checkbox-stat" class="ace" type="checkbox" value="ForAwarding" id="filter_ForAwarding">
                                    <span class="lbl"> For Awarding</span>
                                </label>
                            </div>
                            <div class="col-md-4">
                                <label class="label label-lg label-info arrowed-in-right arrowed">
                                    <input name="form-field-checkbox-stat" class="ace" type="checkbox" value="Awarded" id="filter_Awarded">
                        ...
                        <div class="form-group row" style="margin: 0px;">
                            <div class="col-md-4">
                                <label class="label label-lg label-success arrowed-in-right arrowed">
                                    <input name="form-field-checkbox-stat" class="ace" type="checkbox" value="Confirmed" id="filter_Confirmed">
                    ...
                    <div class="form-group row" style="padding-left:8px;margin-bottom:0px;">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-xs btn-info btn-round" onclick="saveLeasingApplicationFilter()" style="float:right;margin-bottom:10px;margin-right:10px;width:80px;">OK</button>
                        </div>
...
<div class="modal fade" id="mdlAwardConfirmation" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-group">
                    <button class="btn btn-round btn-sm btn-success" data-toggle="dropdown" class="btn dropdown-toggle" aria-expanded="false">
                        Print
                        <span class="ace-icon fa fa-caret-down icon-on-right"></span>
                    </button>

                    <ul class="dropdown-menu dropdown-default" id="btnAwardNoticePreview"></ul>
                </div>
...
<div class="modal fade fade-scale" id="mdlCancelRemark" role="dialog" area-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-sm">   
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="hidemodal_login_override();">&times;</button>
                <h4 class="modal-title" style="font-size: 18px;">Cancel Application</h4>
            </div>
            <div class="modal-body">
                <div class="row form-group">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <textarea class="form-control" style="height: 100px; resize: none;" id="txtCancelRemarks"></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
               <button class="btn btn-info btn-sm btn-round" id="btnCancelApplication" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Updating...">Proceed</button>
               <button class="btn btn-danger btn-sm btn-round" data-dismiss="modal" >Cancel</button>
            </div>
        </div>
    </div>
</div>
