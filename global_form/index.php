                        ...
                        <div class="row form-group">
                                                ...
                                                <div class="row well">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <button class="btn btn-sm btn-primary pull-right btn-round txtInqDisabled" onclick='ConfshowModalNDTAddCharges();'>Add Charges</button>
                                                                </div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                        ...
                                                                        <table class="table table-striped table-bordered table-hover fixTable">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th style="width: 15%;">Unit Area</th>
                            ...
                            <div class="col-md-12 hide isadmin select-leaseinformation">
                                <div class="widget-container-col ui-sortable" id="widget-container-requirements">
                                    <div class="widget-box transparent ui-sortable-handle collapsed" id="widget-box-12">
                                        <div class="widget-header">
                                            <h4 class="widget-title">Escalation Setup</h4>
                                            <div class="widget-toolbar no-border">
                                                <a href="#" data-action="collapse" class="clicktoshowall" id="GForm-Escalation">
                                                    <i class="ace-icon fa fa-chevron-down"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="widget-body" style="display: none;">
                                            <div class="widget-main">
                                                <div class="row well">
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <h4 class="green">Rent Escalation</h4>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="row form-group">
                                                                        ...
                                                                        <table class="table table-bordered table-striped fixTable">
                                                                            <thead>
                                                                                <tr>
                                                                                    ...
                                                                                    <th style="width: 25%;z-index: 1;">Escalation % Rate</th>
                                                                                    <th style="width: 25%;text-align: right;">Escalation Amount</th>
                                                                                    <th style="width: 25%;text-align: right;">Rent</th>
                                                                                </tr>
                                                                            </thead>
                                                    ...
                                                    <div class="row form-group">
                                                        <div class="col-md-12">
                                                            <h4 class="green">Charge(s) Escalation</h4>
                                                        </div>
                                                        <div class="col-md-12 isOccupancyChanged">
                                                            <div class="row form-group">
                                                                <div class='col-md-12'>
                                                                    <div class='alert alert-danger'>
                                                                        <i class='ace-icon fa fa-exclamation-triangle'></i>
                                                                        You have changes made in occupancy date. Please make sure to update escalation of each charges.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <div style="height: 40vh;">
                                                                        <input type="hidden" id="txtChargeCount" class="txtGlobalZero">
                                                                        <table class="table table-bordered table-striped fixTable">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th style="width: 30%;">Unit</th>
                                                                                    <th style="width: 40%;">Charge Description</th>
                                                                                    <th style="width: 10%;white-space: nowrap;">Year Start</th>
                                                                                    <th style="width: 10%;white-space: nowrap;">Year Basis</th>
                                                                                    <th style="width: 10%;white-space: nowrap;z-index: 1;">Escalation % Rate</th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody id="tblbodyChargesEscalation"></tbody>
                                                                        </table>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row form-group">
                                                                <div class="col-md-12">
                                                                    <div id="divbodyChargesEscalationBreakdown"></div> 
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div> 
...
<div class="modal fade fade-scale" id="mdlAddSelectedCharge" role="dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <div class="widget-box widget-color-blue3">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Select Unit(s)</h5>
                                    </div>
                                    <div class="widget-body">
                                        <div class="widget-main padding-6"> 
                                            <div class="well">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <ul class="list-unstyled" id="ulAddChargeUnitList"></ul>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="widget-toolbox padding-8 clearfix">
                                        <label class="pull-right">
                                            <input type="checkbox" class="ace chkAllSelectedUnits">
                    ...
                    <div class="col-md-7">
                        <div class="row form-group">
                            <div class="col-md-12">
                                <div class="widget-box widget-color-blue3">
                                    <div class="widget-header">
                                        <h5 class="widget-title">Charge Selected</h5>
                                    </div>
                                    <div class="widget-body">
                                        <div class="widget-main padding-6"> 
                                            <div class="well">
            ...
            <div class="modal-footer">
                <div class="btn-group">
                    <button class="btn btn-sm btn-primary btn-round" onclick="fncAddSelectedCharge();"><i class="fa fa-plus"></i>&nbsp;Add</button>
                </div>
            </div>
        </div>
    </div>
