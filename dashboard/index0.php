...
<div class="row">
	<div class="col-md-12">
		<div class="row form-group hide" style="margin-bottom: 0px;">
			<div class="col-md-3" style="padding-bottom: 5px; padding-left: 0px;cursor: pointer;" onclick="window.location = 'index.php?url=tenantrequest&type=trapproval' ">
				<div class="panel panel-success" style="border-color: #C31934;">
                    <div class="panel-heading" style="background-color: #C31934;color: white;">
                        <div class="row">
                            <div class="col-md-3">
                                <i class="fa fa-envelope fa-5x"></i>
                            </div>
                            <div class="col-md-9 text-right">
                                <h1 id="txtapptenantsrequest">0</h1>
                                <h4>Tenant's Request</h4>
                            </div>
                        </div>
                    </div>
                </div>
			...
			<div class="col-md-3" style="padding-bottom: 5px; padding-left: 0px;">
				<div class="panel panel-success" style="border-color: #6B88A5;">
                    <div class="panel-heading" style="background-color: #6B88A5;color: white;">
                        <div class="row">
                            <div class="col-md-3">
			...
			<div class="col-md-3" style="padding-bottom: 5px; padding-left: 0px;">
				<div class="panel panel-success" style="border-color: #107E79;">
                    <div class="panel-heading" style="background-color: #107E79;color: white;">
                        <div class="row">
                            <div class="col-md-3">
			...
			<div class="col-md-3" style="padding-bottom: 5px; padding-left: 0px;">
				<div class="panel panel-success" style="border-color: #CF6A1A;">
                    <div class="panel-heading" style="background-color: #CF6A1A;color: white;">
                        <div class="row">
                            <div class="col-md-3">
		...
		<div class="row form-group" style="margin-bottom: 0px;" id="DashboardPage1">
			...
			<div class="col-md-8 widget-container-col" id="widget-container-col-1" style="padding-bottom: 5px; padding-left: 0px;">
				<div class="widget-box widget-color-green2" id="widget-box-1">
					<div class="widget-header">
						<h4 class="widget-title">Monthly Total Sales From Tenants</h4>
						<div class="widget-toolbar">
							<a href="#" data-action="settings" onclick="ShowTenantSalesGraph()">
								<i class="ace-icon fa fa-bar-chart"></i>
							</a>
							<a href="#" data-action="settings" onclick="ShowTenantSalesTable()">
					...
					<div class="widget-body">
						<div class="widget-main">
							<div id="div_MonthlyTotalSalesFromTenants"></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-4" id="widget-container-col-1" style="padding-bottom: 5px; padding-left: 0px;">
				<div class="widget-box widget-color-green2" id="widget-box-1">
					<div class="widget-header">
						<h4 class="widget-title">Top List Of Tenants Based On Sales</h4>
						<div class="widget-toolbar">
							<a href="#" data-action="collapse">
								<i class="ace-icon fa fa-chevron-up"></i>
							</a>
						...
						<div class="widget-main">
							<div class="row">
								<div style="height: 400px;">
									<div id="div_ListOfTopTenants"></div>
								</div>
							</div>
						</div>
					</div>
